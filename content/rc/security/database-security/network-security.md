...
Redis Enterprise Cloud supports two types of network security: [IP Restrictions](#ip) and [VPCs](#virtual-private-clouds). These features are available in most Redis Enterprise Cloud configurations, as indicated in the table below:
...
4. Next, you'll need to approve the VPC peering request. To do that, log in to your AWS management console.
      ...
      1. Finally, update your routing tables for the peering connection:
            ...
            1. In the Destination field, enter the Requester VPC CIDRs shown when you accepted the peering request.
               ...
               This is the Redis Enterprise Cloud VPC CIDR address, to which your application's VPC should connect.
...
databases in the Redis Enterprise Cloud VPC.
...
When you request a Redis Enterprise Cloud Annual subscription, all databases will be deployed in your own Azure VPC.
